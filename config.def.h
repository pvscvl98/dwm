...
static const char *fonts[]          = { "Hack:size=14", "Font Awesome: size=14", "JoyPixels:size=14" };
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_red, col_black, col_gruv_black },
	[SchemeSel]  = { col_black, col_red, col_urgborder },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_black, "-nf", col_red, "-sb", col_red, "-sf", col_black, NULL };
...
static Key keys[] = {
	...
	{ 0, XF86XK_Favorites,			spawn,						SHCMD("st -e neofetch") },
